              ...
              >
                ...
                <div className="info">
                  ...
                  <div className="buttons flex items-center gap-4 mt-6 justify-center">
                    ...
                    <a
                      href="#contact"
                      className="py-[12px] px-[50px] bg-gradient-to-r from-[#b820e6] to-[#da7d20] text-white font-normal rounded-full text-center flex items-center gap-4 text-base max-sm:px-[20px] max-sm:py-[8px] max-sm:text-xs"
                    >
                      {data?.buttontext}
                      <span>
                        <img
                    ...
                    <div className="flex items-center gap-3 border-[1px] rounded-full py-[12px] px-[50px]  hover:bg-[var(--hover-box--)] text-black bg-[#FFFFFF] text-base max-sm:px-[20px] max-sm:py-[8px]">
                      <a
                        href={resume}
                        download={resume}
                        className="text-base font-normal max-sm:text-xs"
                      >
                        My resume
                      </a>
                      <span>
