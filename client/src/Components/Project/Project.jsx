      ...
      <div className="text-center">
        ...
        <div className="text-center w-[100%] flex flex-col items-center justify-center my-3">
          <p className="dark:text-white text-black text-[16px] font-light leading-[30px] lg:w-[80%]">
            Welcome to my project showcase! As a MERN Stack web developer, I am
            passionate about creating innovative and user-friendly web
            applications that solve real-world problems. In this section, you'll
            find a selection of my projects that demonstrate my skills in
            utilizing MongoDB, Express.js, React.js, and Node.js to build
            dynamic, responsive, and scalable solutions.
          </p>
        </div>
      </div>
      {ProjectData?.project ? (
